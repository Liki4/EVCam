<div align="center">
  ...
  <p>
    <strong>针对领克07、08（2023-2025款）系列车型定制开发的车内环视摄像头行车记录仪应用，兼顾随时远程监看的千里眼功能</strong>
  </p>
...
该应用支持领克07、08（2023-2025款），理论上其它龙鹰一号无高阶智驾车型也可通用，同时支持手机端预览。支持同时从最多 **4 个摄像头**进行视频录制与拍照，支持通过**钉钉机器人**或**微信小程序**远程发送录制、拍照、实时预览指令进行远程监看。这是EVCam的分支版本
...
| 车型 | 摄像头数量 | 录制模式 | 备注 |
|------|-----------|---------|------|
| 领克07 | 4 | MediaRecorder | 默认车型 |
| 领克08 | 4 | MediaRecorder | 默认车型 |
...
- EVCam作者：**wechat**: greenteacher46 (请备注来意)
- 领克07、08车型维护作者：**wechat**：wy467859112(请备注来意)
